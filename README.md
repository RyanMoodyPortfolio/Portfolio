...
_You are lost in a jungle, it is starting to get dark, and you need to find shelter. You see a clearing in the forest, a nearby stream and a tall, old tree.

If you decide to:
* Enter the forest clearing, turn to page 12
* Follow the stream, turn to page 85
* Climb the tree, turn to page 27_
